...
public class BattleFieldInteractive extends IBattleField {
    ...
    /** Costruttori **/
    public BattleFieldInteractive(Context context) {
        super(context);
    }

    public BattleFieldInteractive(Context context, AttributeSet attrs) {
        super(context, attrs);
    }



    public BattleFieldInteractive(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean saveFleet(String levelToLoad, int playerNumber) {
        ...
        if(mLevelManager.checkCorrectFleetConfiguration()) {
            ...
            //write on file
            if(WriterReader.getInstance().write(gridRows, "default",levelToLoad)){
                return true;
            }else{
                return false;
            }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        for (InputObserver io : inputObservers) {
            io.handleInput(event,
                    mGrid, mLevelManager,
                    mGameStateReference.getGameState(), notifyNumber);
        }
